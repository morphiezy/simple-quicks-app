const SearchBar = ({ placeholder }) => {
  return (
    <div className="w-full h-[58px] bg-[#4F4F4F] relative">
      <svg
        width="32"
        height="31"
        viewBox="0 0 32 31"
        ...
        className="absolute w-[16px] h-[16px] translate-y-[-50%] top-1/2 left-[25px]"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <input
        ...
        className="w-full h-full bg-transparent focus:outline-0 pl-14 text-white pr-5"
      />
    </div>
  );
};
